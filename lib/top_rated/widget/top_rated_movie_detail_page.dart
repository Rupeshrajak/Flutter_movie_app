...
class TopRatedMovieDetails extends StatefulWidget {
  final Results movieDetails;

  const TopRatedMovieDetails(this.movieDetails, {super.key});

  @override
  State<TopRatedMovieDetails> createState() => _TopRatedMovieDetailsState();
}

class _TopRatedMovieDetailsState extends State<TopRatedMovieDetails> {
  @override
